...
return {
    ...
    handlers = {
        ["textDocument/rename"] = function(_, res, ctx)
            res.changeAnnotations = res.changeAnnotations or change_annotations
            vim.lsp.handlers["textDocument/rename"](_, res, ctx)
        end,
    },
    settings = {
        python = {
